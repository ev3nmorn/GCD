...
namespace GCD
{
    public class GF2m
    {
        Dictionary<string, uint> elements;
        uint fieldMod, bitsPerElement, highBitPoly;

        private uint GetHighBit(uint value)
        {
        ...
        private uint ElementsMult(uint op1, uint op2)
        {
            uint result = 0;
            uint hiBitSet;
        ...
        public GF2m(uint irreduciblePolynomial)
        {
        ...
        private string ElementToBitStr(uint value)
        {
        ...
        public Dictionary<string, uint> Elements
        {
            get
            {
                return elements;
